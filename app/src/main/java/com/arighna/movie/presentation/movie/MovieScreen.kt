...
fun MovieScreen(viewModel: MovieViewModel = hiltViewModel()) {
    ...
    LaunchedEffect(movies.loadState) {
        ...
        if (refreshState is LoadState.Error) {
            ...
            if (error is com.arighna.movie.data.di.NoConnectivityException) {
    ...
    Scaffold(
        ...
        Column(
            ...
            if (isOffline) {
                ...
                _root_ide_package_.com.arighna.movie.presentation.components.GenreDropdown(
                    genres = genres,
    ...
    LazyColumn(
        ...
        items(movies.itemCount) { index ->
            movies[index]?.let { movie ->
                _root_ide_package_.com.arighna.movie.presentation.components.MovieItem(
                    movie = movie,
